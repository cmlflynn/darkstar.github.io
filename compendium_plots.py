...
[
  ...
  {"id": "deason2011", "title": "Deason et al. (2011)", "luminosity": "3.17e+08 L⊙", "range": {"min": 1, "max": 40}},
  ...
  {"id": "li2026", "title": "Li et al. (2026)", "luminosity": "4.10e+08 L⊙", "range": {"min": 10, "max": 100}},
  ...
  {"id": "suzuki2026", "title": "Suzuki et al. (2026)", "luminosity": "5.68e+08 L⊙", "range": {"min": 5, "max": 100}},
...
class ModelPhysics:
    ...
    def get_density(id, r):
        ...
        if id == 'thomas2018': return bpl(r, 4.24, 3.21, 41.4)
        ...
        if id == 'yu2024': return spl(r, 4.34)
...
> (the integrated luminosity of the halo). Latest update: 19-06-26
"""
    print(disclaimer)
...
ne. Check the current directory for PDF and PNG outputs.")
uts.")
ne. Check the current directory for PDF and PNG outputs.")
