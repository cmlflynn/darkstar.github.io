...
def calculate_stringer2021_halo():
    ...
    # Model: Broken Power Law (BHB stars)
    alpha_in = 2.5
    ...
    print(f"--- Stringer et al. (2021) BHB Halo Properties ---")
    ...
    plt.loglog(r_vals, rho_vals / (1000**3), color='darkgoldenrod', linewidth=2, label='Stringer et al. (2021) Model (1 kpc Core)')
    ...
    plt.title('Milky Way Stellar Halo Density Profile (Stringer et al. 2021)', fontsize=14)
