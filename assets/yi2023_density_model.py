...
def calculate_yi2023_halo():
    ...
    print(f"--- Yi et al. (2023) LAMOST-Gaia Halo Properties ---")
    ...
    plt.loglog(r_vals, rho_vals / (1000**3), color='forestgreen', linewidth=2, label='Yi et al. (2023) Model (1 kpc Core)')
    ...
    plt.title('Milky Way Stellar Halo Density Profile (Yi et al. 2023)', fontsize=14)
