...
def calculate_yi2023_halo():
    # Parameters from Yi et al. (2023) - MNRAS 525, 2472
    ...
    print(f"--- Yi et al. (2023) Gaia DR3 RR Lyrae Halo Properties ---")
    ...
    plt.loglog(r_vals, rho_vals / (1000**3), color='forestgreen', linewidth=2, label='Yi et al. (2023) RR Lyrae Model (1 kpc Core)')
    ...
    plt.title('Stellar Halo Density Profile (Yi et al. 2023)', fontsize=14)
    plt.xlabel('Radius $r$ [kpc]', fontsize=12)
    plt.ylabel('Luminosity Density [$L_\\odot/pc^3$]', fontsize=12)
    plt.legend(frameon=True)
    plt.grid(True, which="both", ls="-", alpha=0.2)
    
    plt.savefig('assets/yi2023_density_profile.png', dpi=300)
    print("Plot saved to: assets/yi2023_density_profile.png")

if __name__ == "__main__":
    calculate_yi2023_halo()
